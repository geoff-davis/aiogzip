...
|---------------------------- | -------: | -------: | -------: | -------: | ---------: | --------: |
| src/aiogzip/\_\_init\_\_.py |       46 |        0 |       22 |        6 |     91.18% |120-\>exit, 141-\>exit, 159-\>exit, 204-\>exit, 225-\>exit, 243-\>exit |
...
| src/aiogzip/\_engine.py     |       35 |        3 |        6 |        3 |     85.37% |62, 82, 95 |
